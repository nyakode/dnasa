...
class Infemergencia {
   ...
   public static function readOne($data) {
      $sql = "SELECT id, contacto, relacion, telefono FROM inf_emergencia WHERE  id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function readAll() {
      $sql = "SELECT id, contacto, relacion, telefono FROM inf_emergencia";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql);
         if ($rst) {
   ...
   public static function filter($data) {
      $sql = "SELECT id, contacto, relacion, telefono FROM inf_emergencia WHERE telefono = :telefono";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function update($data) {
      $sql = "UPDATE inf_emergencia SET contacto=:contacto,relacion=:relacion,telefono=:telefono WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function delete($data) {
      $sql = 'DELETE FROM inf_emergencia WHERE id = :id';
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
