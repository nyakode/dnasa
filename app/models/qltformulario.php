...
class Qltformulario {
   public static function create($data) {
		$sql = "INSERT INTO qlt_formulario(frm_nombre, frm_descripcion, tipo_form, creador, estado, creacion) VALUES VALUES (:frm_nombre, :frm_descripcion, :tipo_form, :creador, :estado, :creacion)";
		try {
	...
	public static function readOne($data) {
		$sql = "SELECT qf.id, qf.frm_nombre, qf.frm_descripcion, qf.tipo_form, cft.tipo,qf.creador, il.usuario, qf.estado, qf.creacion FROM qlt_formulario qf LEFT JOIN inf_laboral il ON il.id = qf.creador LEFT JOIN cfg_tipoform cft ON cft.id = qf.tipo_form  WHERE  qf.id = :id";
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute($data);
	...
	public static function readAll() {
		$sql = "SELECT qf.id, qf.frm_nombre, qf.frm_descripcion, qf.tipo_form, cft.tipo,qf.creador, il.usuario, qf.estado, qf.creacion FROM qlt_formulario qf LEFT JOIN inf_laboral il ON il.id = qf.creador LEFT JOIN cfg_tipoform cft ON cft.id = qf.tipo_form";
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute();
