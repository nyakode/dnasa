...
class Cfgjefe {
	...
	public static function create($data) {
		$sql = "INSERT INTO cfg_jefes(nombre, usuario) VALUES (:nombre, :1usuario)";
		try {
	...
	public static function readOne($data) {
		$sql = "SELECT * FROM cfg_jefes WHERE  id = :id";
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute();
	...
	public static function filter($data) {
		$sql = "SELECT * FROM cfg_jefes WHERE usuario = :usuario OR nombre = :nombre";
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute($data);
	...
	public static function update($data) {
		$sql = "UPDATE cfg_jefes SET nombre = :nombre, usuario = :usuario";
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute($data);
	...
	public static function delete($data) {
		$sql = 'DELETE FROM cfg_jefes WHERE id = :id';
		try {
			$cn    = \Core\Models::instance();
			$query = $cn->consulta($sql);
			$query->execute($data);
