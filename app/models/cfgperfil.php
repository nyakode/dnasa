...
class Cfgperfil {
   ...
   public static function create($data) {
      $sql = "INSERT INTO cfg_perfiles (perfil) VALUES (:perfil)";
      try {
   ...
   public static function readOne($data) {
      $sql = "SELECT id, perfil FROM cfg_perfiles WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function readAll() {
      $sql = "SELECT id, perfil FROM cfg_perfiles";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql);
         if ($rst) {
   ...
   public static function filter($data) {
      $sql = "SELECT id, perfil FROM cfg_perfiles WHERE perfil = :perfil";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
