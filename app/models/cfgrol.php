...
class Cfgrol {
   ...
   public static function create($data) {
      $sql = "INSERT INTO cfg_roles(rol, detalle) VALUES (:rol, :detalle)";
      try {
   ...
   public static function readOne($data) {
      $sql = "SELECT id, rol, detalle FROM cfg_roles WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function readAll() {
      $sql = "SELECT id, rol, detalle FROM cfg_roles";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql);
         if ($rst) {
   ...
   public static function filter($data) {
      $sql = "SELECT id, rol, detalle FROM cfg_roles WHERE rol = :rol";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function update($data) {
      $sql = "UPDATE cfg_roles SET rol = :rol, detalle = :detalle WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function delete($data) {
      $sql = 'DELETE FROM cfg_roles WHERE id = :id';
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
